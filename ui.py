...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(480, 669))
        MainWindow.setMaximumSize(QtCore.QSize(480, 669))
        ...
        self.input_amount.setGeometry(QtCore.QRect(50, 320, 380, 60))
        font = QtGui.QFont()
...
"color: white;")
        ...
        self.output_amount.setDisabled(True)
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(50, 480, 380, 60))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(14)
        font.setBold(True)
...
"}")
        ...
        self.frame.setStyleSheet("background-color: #a7d984")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.label = QtWidgets.QLabel(self.frame)
        self.label.setGeometry(QtCore.QRect(150, 80, 191, 171))
        self.label.setText("")
...
"")
        ...
        self.input_currency.setGeometry(QtCore.QRect(50, 400, 380, 60))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(14)
        font.setBold(True)
...
"color: white;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "            Перевод в СИ"))
